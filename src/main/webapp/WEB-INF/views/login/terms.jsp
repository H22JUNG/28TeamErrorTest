...
<input type="checkbox" name="agree" id="agree"><label
			for="agree" class="saveck">위 약관을 읽고 이에 동의합니다</label>
</pre>
	<div class="bottom">
	...
	var style = opener.document.head.appendChild(document.createElement("style"));
	agree.addEventListener("click",function(){
		if(agree.checked) {
				opener.agree.checked = true;
		     	style.innerHTML = ".saveck:after {display: block;}";
				window.close();
		    } else {
		    	opener.agree.checked = false;
